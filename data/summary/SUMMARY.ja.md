...
[English](SUMMARY.md) | 日本語

## 公平な抽選

|課題|件数|既知の正答確率|平均報告確率|実測正答率|
|---|---:|---:|---:|---:|
...
保存結果・再構成入力の整合性確認。HTTP本文の歴史的証明やAPI再実行ではない。Noulの`correct`は命題の実現値であり、モデルの正答フラグではない。
